...
import LowPassFilter from '../../../src/components/filters/LowPassFilter'
...
describe("LowPassFilter", () => {
  ...
  const wrapper = mount(
    <LowPassFilter lowpassfilter={_prophet6.lowpassfilter}
  ...
  it('renders LowPassFilter component and sub components', () => {
